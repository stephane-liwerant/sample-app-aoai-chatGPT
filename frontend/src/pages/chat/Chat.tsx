...
import AskAI from "../../assets/ask-ai.svg";
                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Chatventures Begin</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>
                                    Welcome to Sociabble AskAI! I'm here to ignite your creativity and streamline content creation, ideas, and training. <br />
                                    Let's have a fantastic time together! Your data is safe with me - not used for training or stored. <br />
                                    Enjoy this secure and fun experience!
                                </h2>
                            </Stack>
                        ) : (
